...
export default function ProductDetailPage() {
  ...
  const points = Math.ceil(
    product.basePrice / selectedBank.pointRatio
  ).toLocaleString();

  // Simulate multiple product images using the same image
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      ...
      <nav className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>/</span>
        <Link
          href={`/store/search?category=${product.category}`}
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <div className="flex-1 lg:w-1/2">
          ...
          <h1 className="mb-4 text-pretty text-3xl font-bold text-foreground">
            {product.title}
          </h1>
          ...
          <div className="mb-6 rounded-xl border border-border bg-muted p-6">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              1 point = {selectedBank.pointRatio} INR
            </p>
          </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <span className="text-lg font-bold text-primary">
                    {Math.ceil(
                      p.basePrice / selectedBank.pointRatio
                    ).toLocaleString()}{" "}
                    pts
                  </span>
                </div>
